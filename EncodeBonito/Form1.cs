    ...
    public partial class frmMain : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (txtUser.Text == "admin" && txtPass.Text == "admin")
            {
                ...
                InputPassword.Text = "";
                decryptInputFileURL.Text = "";
                decryptOutputFileURL.Text = "";
                encryptInputFileURL.Text = "";
                encryptOutputFileURL.Text = "";
        ...
        private void btnInputFileEncrypt_Click(object sender, EventArgs e)
        {
            OpenFileDialog.Filter = "Text|*.txt|All|*.*";
            if (OpenFileDialog.ShowDialog() == DialogResult.OK)
            {
                encryptInputFileURL.Text = OpenFileDialog.FileName;
            }
        }

        private void btnEncryptFile_Click(object sender, EventArgs e)
        {
            Cifrador.EncryptFile(encryptInputFileURL.Text, encryptOutputFileURL.Text);
        }

        private void btnOutputFileEncrypt_Click(object sender, EventArgs e)
        {
            OpenFileDialog.Filter = "Text|*.txt|All|*.*";
            if (OpenFileDialog.ShowDialog() == DialogResult.OK)
            {
                encryptOutputFileURL.Text = OpenFileDialog.FileName;
            }

        }

        private void btnInputFileDecrypt_Click(object sender, EventArgs e)
        {
            OpenFileDialog.Filter = "Text|*.txt|All|*.*";
            if (OpenFileDialog.ShowDialog() == DialogResult.OK)
            {
                decryptInputFileURL.Text = OpenFileDialog.FileName;
            }
        }

        private void btnOuputFileDecrypt_Click(object sender, EventArgs e)
        {
            OpenFileDialog.Filter = "Text|*.txt|All|*.*";
            if (OpenFileDialog.ShowDialog() == DialogResult.OK)
            {
                decryptOutputFileURL.Text = OpenFileDialog.FileName;
            }
        }

        private void btnDecryptFile_Click(object sender, EventArgs e)
        {
            Cifrador.DecryptFile(decryptInputFileURL.Text,decryptOutputFileURL.Text);
        }

        private void btnCriptoFiles_Click(object sender, EventArgs e)
        {
            pnlOnButtonPosition.Height = btnCriptoFiles.Height;
            pnlOnButtonPosition.Top = btnCriptoFiles.Top;
            pnlPassword.Visible = false;
            pnlEncrypt.Visible = false;
            pnlDecrypt1.Visible = false;
            pnlEncryptFiles.Visible = true;
        }
    }
}
